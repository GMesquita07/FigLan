...
public class FiglanLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "FOR", "TO", "DO", "END", "NEW", "SHOW", "HIDE", 
			"ALL", "PAUSE", "PRINT", "PRINTLN", "READ", "INTEGER_KW", "REAL_KW", 
			"TEXT_KW", "POINT_KW", "LINE_KW", "CIRCLE_KW", "FIGURE_KW", "LBRACK", 
			"RBRACK", "PIPE", "DASHDASH", "ID", "INT", "REAL", "STRING", "COMMENT_SLASH", 
			"COMMENT_HASH", "COMMENT_BLOCK", "WS"
		};
	}
