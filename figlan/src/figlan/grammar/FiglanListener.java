...
public interface FiglanListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterTypeConversion(FiglanParser.TypeConversionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code TypeConversion}
	 * labeled alternative in {@link FiglanParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitTypeConversion(FiglanParser.TypeConversionContext ctx);
	/**
	 * Enter a parse tree produced by the {@code MulDivMod}
	 * labeled alternative in {@link FiglanParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterMulDivMod(FiglanParser.MulDivModContext ctx);
	/**
	 * Exit a parse tree produced by the {@code MulDivMod}
	 * labeled alternative in {@link FiglanParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitMulDivMod(FiglanParser.MulDivModContext ctx);
	/**
